...
function AdminLogin() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post("http://localhost:3001/adminlogin", { adminemail, adminpassword })
            .then(result => {
                console.log(result);
        ...
        <>
            ...
            <div className="flex flex-col justify-center text-black dark:text-white items-center h-screen font-semibold duration-500">
                <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary"><center>Admin Login</center></h2>
                </div>
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    <Link to="/adminsignup" className="w-full flex justify-center rounded-md  px-4 py-2 text-sm font-semibold secondary-btn focus:ring-2 focus:ring-offset-2">
                        Sign Up
                    </Link>
                </div>
                {/* Animated Blob */}
