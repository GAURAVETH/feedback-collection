                    ...
                    <div>
                        ...
                        <div className="mt-2">
                            <input
                                ...
                                autoComplete='off'
                                name='email'
                                className="block w-full rounded-md border-0  p-2 text-gray-900  dark:text-white shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
