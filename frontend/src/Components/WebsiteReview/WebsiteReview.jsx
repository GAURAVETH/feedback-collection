...
const WebsiteReview = () => {
    ...
    const [websiteemail, setEmail] = useState('');
    const [websiterating, setRating] = useState(0); // Initialize rating state with 0
    const [websitefeedback, setFeedback] = useState('');
    const navigate = useNavigate();

    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post("http://localhost:3001/websitereview", { websitename, websiteemail, websiterating, websitefeedback })
            .then(result => {
                console.log(result);
        ...
        <div className="h-screen">
            ...
            <div className='flex flex-col h-screen  justify-center items-center' style={{ height: "calc(100vh - 10vh)" }}>
                ...
                <div className='p-6 max-w-lg mx-auto rounded-md shadow-md'>
                    <h2 className="text-2xl font-semibold mb-4">website Feedback Form</h2>
